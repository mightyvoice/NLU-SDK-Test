...
//        }
        ...
        if (audioDialogManager.getDomain().equals("calling")) {
            AudioCallingDomain callingDomain
        ...
        if (audioDialogManager.getDomain().equals("messaging")) {
            AudioMessageDomain audioMessageDomain
            ...
            if (audioDialogManager.getIntent().equals("send") &&
                ...
                smsManager.sendTextMessage(phoneNumber, null, audioMessageDomain.getMessageContent(), null, null);
            }
        }
    }
    ...
    private class TextRecognitionAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            if(textForRecognition != null && !textForRecognition.equals("")){
                textServerResponse = new CloudTextRecognizer(
                        AppInfo.dataUploadUniqueID,
                        AppInfo.applicationSessionID,
                        textForRecognition
                ).startTextRecognition(textForRecognition);
            }
            return null;
        }
    ...
    /**
     * Process the returned json from text recognition each time
     */
